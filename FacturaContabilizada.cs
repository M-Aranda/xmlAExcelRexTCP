...
{
    internal class FacturaContabilizada
    {
        ...
        public FacturaContabilizada convertirFacturaAIngresarAFacturaContabilizada(Factura f)
        {
            FacturaContabilizada fc = new FacturaContabilizada();

            fc.TipoDeDocumento = f.TipoDeDocumento;
            fc.NumeroDelDocumento = f.NumeroDelDocumento;
            fc.FechaDeDocumento = f.FechaDeDocumento;
            fc.FechaContableDeDocumento = f.FechaContableDeDocumento;
            fc.FechaDeVencimientoDeDocumento = f.FechaDeVencimientoDeDocumento;
            fc.CodigoDeUnidadDeNegocio = f.CodigoDeUnidadDeNegocio;
            fc.RutCliente = f.RutCliente;
            fc.DireccionDelCliente = f.DireccionDelCliente;
            fc.RutFacturador = f.RutFacturador;
            fc.CodigoVendedor = f.CodigoVendedor;
            fc.CodigoComisionista = f.CodigoComisionista;
            fc.Probabilidad = f.Probabilidad;
            fc.ListaPrecio = f.ListaPrecio;
            fc.PlazoPago = f.PlazoPago;
            fc.MonedaDelDocumento = f.MonedaDelDocumento;
            fc.TasaDeCambio = f.TasaDeCambio;
            fc.MontoAfecto = f.MontoAfecto;
            fc.MontoExento = f.MontoExento;
            fc.MontoIva = f.MontoIva;
            fc.MontoImpuestosEspecificos = f.MontoImpuestosEspecificos;
            fc.MontoIvaRetenido = f.MontoIvaRetenido;
            fc.MontoImpuestosRetenidos = f.MontoImpuestosRetenidos;
            fc.TipoDeDescuentoGlobal = f.TipoDeDescuentoGlobal;
            fc.DescuentoGlobal = f.DescuentoGlobal;
            fc.TotalDelDocumento = f.TotalDelDocumento;
            fc.DeudaPendiente = f.DeudaPendiente;
            fc.TipoDocReferencia = "";//no se ingresa en documento contable con detalles
            fc.NumDocReferencia = "";//no se ingresa en documento contable con detalles
            fc.FechaDocReferencia = "";// no se ingresa en documento contable con detalles
            fc.CodigoDelProducto = f.CodigoDelProducto;
            fc.Cantidad = f.Cantidad;
            fc.Unidad = f.Unidad;
            fc.PrecioUnitario = f.PrecioUnitario;
            fc.MonedaDelDetalle = f.MonedaDelDetalle;
            fc.TasaDeCambio2 = f.TasaDeCambio2;
            fc.NumeroDeSerie = f.NumeroDeSerie;
            fc.NumeroDeLote = f.NumeroDeLote;
            fc.FechaDeVencimiento = f.FechaDeVencimiento;
            fc.CentroDeCostos = f.CentroDeCostos;
            fc.TipoDeDescuento = f.TipoDeDescuento;
            fc.Descuento = f.Descuento;
            fc.Ubicacion = f.Ubicacion;
            fc.Bodega = f.Bodega;
            fc.Concepto1 = f.Concepto1;
            fc.Concepto2 = f.Concepto2;
            fc.Concepto3 = f.Concepto3;
            fc.Concepto4 = f.Concepto4;
            fc.Descripcion = f.Descripcion;
            fc.DescripcionAdicional = f.DescripcionAdicional;
            fc.Stock = f.Stock;
            fc.Comentario11 = f.Comentario11;
            fc.Comentario21 = f.Comentario21;
            fc.Comentario31 = f.Comentario31;
            fc.Comentario41 = f.Comentario41;
            fc.Comentario51 = f.Comentario51;
            fc.CodigoImpuestoEspecifico1 = "";
            fc.MontoImpuestoEspecifico1 = "";
            fc.CodigoImpuestoEspecifico2 = "";
            fc.MontoImpuestoEspecifico2 = "";
            fc.Modalidad = f.Modalidad;
            fc.Glosa = f.Glosa;
            fc.Referencia = f.Referencia;
            fc.FechaDeComprometida = f.FechaDeComprometida;
            fc.PorcentajeCEEC = f.PorcentajeCEEC;
            fc.ImpuestoLey18211 = "";
            fc.IvaLey18211 = "";
            fc.CodigoKitFlexible = f.CodigoKitFlexible;
            fc.AjusteIva = f.AjusteIva;
